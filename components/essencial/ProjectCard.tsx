    ...
    <>
      <article className="group grid gap-8 border-t border-[#E4E2DD] py-12 md:grid-cols-2 md:items-center md:gap-14 md:py-16">
        ...
        >
          ...
          {/* IMAGEM — aparece aqui no mobile */}
          <button
            type="button"
            onClick={() => setIsOpen(true)}
            className="
              group/image mt-6 overflow-hidden rounded-2xl
        ...
        {/* IMAGEM — desktop permanece exatamente na coluna original */}
        <button
          type="button"
          onClick={() => setIsOpen(true)}
          className={`
            group/image hidden overflow-hidden rounded-2xl
            border border-[#E4E2DD]
            bg-[#F7F6F2] text-left
            shadow-[0_8px_30px_rgba(22,24,27,0.05)]
            transition-all duration-500
